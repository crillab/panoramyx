...
#ifndef PANORAMYX_RANGEBASEDALLOCATIONSTRATEGY_HPP
#define PANORAMYX_RANGEBASEDALLOCATIONSTRATEGY_HPP
...
namespace Panoramyx {
    ...
    /**
     * The RangeBasedAllocationStrategy defines a bound allocation that divides a range of bounds
     * into several sub-intervals.
     */
    class RangeBasedAllocationStrategy : public Panoramyx::IBoundAllocationStrategy {
