...
namespace Panoramyx {
    ...
    /**
     * The FinalConsistencyChecker is a consistency checker that checks cube
     * consistency when all assumptions have been added.
     */
    class FinalConsistencyChecker : public Panoramyx::IConsistencyChecker {
    ...
    public:
        ...
        /**
         * Creates a new FinalConsistencyChecker.
         *
        ...
        /**
         * Destroys this FinalConsistencyChecker.
         */
        ~FinalConsistencyChecker() override = default;
